...
# **3 Lightweight models that require VERY LITTLE storage**
models = [
    "distilgpt2",  # 256MB (smallest GPT-2)
    "facebook/blenderbot-90M",  # 88MB (smallest BlenderBot)
    "microsoft/DialoGPT-small"  # 350MB (smallest DialoGPT)
]
